            ...
            <table align="center" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <table align="left" width="100%" cellpadding="0" cellspacing="0" style="margin-top:30px; font-family:arial;">
                        ...
                        @foreach ($results as $result)
                            ...
                            <tr>
                                <td style="padding-left:3%;" valign="top" style="color:#000;">
                                    <div><a href="{{$domain}}show/{{str_replace(' ','_',$result->name)}}/{{$result->id}}" style="color:#1d7293;text-decoration:none;font-size:18px;">{{$result->full_address}} {{$result->unit}}</a></div>
                                    @if($lastmail && $result->created_at > $lastmail)<div style="margin-top:9px; font-size:13px;color:orange;">(NEW)</div>@endif
                                    <div style="margin-top:10px;"><span style="font-size:18px">${{$result->price}}</span> <span style="font-size:12px;"><b>FOR @if($result->estate_type==2) RENT @else SALE @endif</b></span></div>
                        ...
                        <tr><td colspan=2 align=center><a href="{{$domain}}search/{{$search_id}}" style="font-size:18px;text-decoration:none;color:#1d7293;">More Listing >></a></td></tr>
