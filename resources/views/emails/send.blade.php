                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="content-cell">
                                    ...
                                    <p style="font-family: Arial; box-sizing: border-box; color: #000; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Adverts: <a href="{{$data['advertLink']}}">{{$data['advertLink']}}</a></p>
                                    @endif
