                    ...
                    <table align="left" width="100%" cellpadding="0" cellspacing="0" style="margin-top:30px; font-family:arial;">
                        ...
                        <tr>
                            <td style="padding-left:3%;" valign="top" style="color:#000;">
                                <div><a href="{{$domain}}building/{{str_replace(' ','_',$result->building_name)}}/{{str_replace(' ','_',$result->building_city)}}" style="color:#1d7293;text-decoration:none;font-size:18px;">{{html_entity_decode(str_replace(' ','&zwnj; ',$result->building_name))}}</a></div>
