            ...
            <div class="container">
                <div class="building-desc">
                    <div class="slider" style="max-height:380px;overflow:hidden;">
                        ...
                        <div class="listed-meta" style="border:solid 0px;text-align:right;display:none;">
                            <div class="logo-listed" style="float:right">
                                <img src="http://s3.amazonaws.com/images-rental/logo/30061/2296510/corcoran_2x.png" style="border:solid 3px red;max-width:150px;" alt="">
                            </div>
                        </div>
                ...
                <div class="content-side building">
                    ...
                    <div class="description" style="height:125px;">
                        <div style="border: solid 3px red; float:left;padding:5px;">
                        ...
                        <div style="float:left;width:100%;">
                            <br>
                            [Your description will be placed here...]   
                        </div>
                    </div>
